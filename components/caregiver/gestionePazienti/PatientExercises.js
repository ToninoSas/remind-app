...
import { assignExerciseAction, unassignExerciseAction, } from "@/lib/actions/assignments";
                    ...
                    data.esercizi.map((ex, i) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <span
                                    className={`px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest border ${ex.Status === "completato"
