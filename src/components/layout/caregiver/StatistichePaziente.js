...
export default function StatistichePaziente({ stats }) {
  ...
  if (!metrics) return <p className="text-slate-600">Nessun dato disponibile per le statistiche.</p>;
